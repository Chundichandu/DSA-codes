...
*/
	...
	// Task 1 Solution
	Tree* z = create_node(key, NULL, NULL);
	Tree* temp1 = tree;
	Tree* temp2 = NULL;
	while(temp1 != NULL){
		temp2 = temp1;
...
*/
	...
	return z->key; // You may want to edit this
}
...
*/
	...
	if(key< tree->key){
		...
		tree->key = temp->key;
		tree->right = delete(temp->key,tree->right);
	}
